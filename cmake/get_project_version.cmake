function(getProjectVersion config_file_path)
    ...
    string(REGEX MATCH "define[ \t]+${lib_name_upper}_MAJOR_VERSION[ \t]+([0-9]+)" lib_name_major_version_match ${config_file})
    set(lib_name_major_version "${CMAKE_MATCH_1}")

    string(REGEX MATCH "define[ \t]+${lib_name_upper}_MINOR_VERSION[ \t]+([0-9]+)" lib_name_minor_version_match ${config_file})
    set(lib_name_minor_version "${CMAKE_MATCH_1}")

    string(REGEX MATCH "define[ \t]+${lib_name_upper}_PATCH_VERSION[ \t]+([0-9]+)" lib_name_patch_version_match ${config_file})
