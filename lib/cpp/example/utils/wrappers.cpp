...
int main ()
{
    ...
    auto func = wrap::poly::fd::gradient(Func{});

    // auto grad1 = wrap::poly::gradient(Grad1{});
    // auto grad2 = wrap::poly::gradient(Grad2{});

    // auto funcGrad1 = wrap::poly::funcGrad(Func{}, Grad2{});
    // auto funcGrad2 = wrap::poly::funcGrad(FuncGrad2{});
    // // auto funcGrad3 = wrap::poly::funcGrad(Func{});
    // auto funcGrad3 = wrap::poly::fd::funcGrad(Func{});

    // auto hess = wrap::poly::hessian(Hessian{});

    // auto funcs = wrap::poly::fd::functions<wrap::Conditions::AllFunctions, Eigen::VectorXf>(genericFunction);
